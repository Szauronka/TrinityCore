...
namespace WorldPackets
{
    namespace Character
    {
        ...
        struct CharacterCreateInfo
        {
            ...
            Array<ChrCustomizationChoice, 71> Customizations;
        ...
        struct CharFactionChangeDisplayInfo
        {
            ...
            uint8 SexID             = 0;
            uint8 RaceID            = RACE_NONE;
            Array<ChrCustomizationChoice, 71> const* Customizations = nullptr;
        };
        ...
        public:
            ...
            std::string CharName;
            uint8 SexID = 0;
            Array<ChrCustomizationChoice, 71> const& Customizations;
        };
